...
def create_jane!
  ...
  ryan_seat = Seat.create(name: 'Ryan', email: 'ryan@example.com', team_id: blue_team.id)
  shirish_seat = Seat.create(name: 'Shirish', email: 'shirish@example.com', team_id: blue_team.id)
  ...
  Response.create(handled: false, seat: shirish_seat, body: <<~EOS)
    Beat Eric at Ping-Pong!
  EOS
  Response.create(handled: false, seat: ryan_seat, body: <<~EOS)
